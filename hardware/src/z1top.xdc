...
# set_property -dict { PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports RTS];
# set_property -dict { PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports CTS];
set_property -dict { PACKAGE_PIN W18 IOSTANDARD LVCMOS33 IOB TRUE} [get_ports FPGA_SERIAL_TX];
set_property -dict { PACKAGE_PIN W19 IOSTANDARD LVCMOS33 IOB TRUE} [get_ports FPGA_SERIAL_RX];
